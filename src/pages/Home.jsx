...
import HomeNavbar from "../components/HomeNavbar"; // 👈 import the new HomeNavbar
...
function Countdown({ targetDateIso }) {
  ...
  return (
    <div className="countdown" aria-hidden>
      ...
      <div
        className="count-item animate-pop"
    ...
    const sample = [
      {
        ...
        date: "2025-08-20",
        snippet: "A beautiful walk by the river.",
      },
      {
        id: "m2",
        title: "Home-cooked dinner",
        date: "2025-07-10",
        snippet: "Tried that new pasta recipe.",
      },
      {
        id: "m3",
        title: "Cinema night",
        date: "2025-06-02",
        snippet: "Laughs and popcorn.",
      },
    ];
        ...
        <div className="hero hero-couple">
          <div className="container hero-inner">
            <div className="hero-left">
              ...
              <p className="lead">
                A cozy corner for memories, photos and tiny notes — just for the
                two of you.
              </p>

              <div className="cta-row">
                <Link to="/gallery" className="btn btn-glow">
                  Gallery
                </Link>
              ...
              <div className="small-note">
                Tip: click <strong>Gallery</strong> to add photos (we'll wire
                uploads later).
              </div>
            </div>
            ...
            <div className="hero-right card-glass">
              ...
              <div className="muted small">
                Edit the date in <code>src/pages/Home.jsx</code>
              </div>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="memory-body">
                    ...
                    <div style={{ marginTop: 8 }}>
                      <Link to="/patients" className="btn btn-sm">
                        View
                      </Link>
                    </div>
                  </div>
